...
/// DETAYLI AÇIKLAMA:
/// ────────────────
/// Bu dosya, SSE (Server-Sent Events) istemcisini platform bazlı export eder.
///
/// SSE NEDİR:
/// SSE, sunucudan istemciye tek yönlü gerçek zamanlı veri akışı sağlar.
/// Bu projede LLM yanıtları token token alınır (streaming).
///
/// PLATFORM AYRIMI:
